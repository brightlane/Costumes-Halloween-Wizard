...
PAGES = [
    ...
    {"slug":"womens-costumes-2026",       "filename":"womens-costumes-2026.html",        "title":f"Women's Halloween Costumes {YEAR}",       "h1":f"👩 Women's Halloween Costumes {YEAR}",                               "description":f"Shop the hottest women's Halloween costumes {YEAR}. Sexy, funny, scary, classic and group styles. Fast shipping.",                                           "merchant":"/womens-halloween-costumes.html",     "emoji":"👩","label":"Women's",    "priority":"0.9"},
    {"slug":"mens-costumes-online",       "filename":"mens-costumes-online.html",        "title":f"Men's Halloween Costumes {YEAR}",         "h1":f"👨 Men's Halloween Costumes {YEAR}",                                 "description":f"Best men's Halloween costumes {YEAR}. Superheroes, horror, funny, historical and more. Ships worldwide.",                                                   "merchant":"/mens-halloween-costumes.html",       "emoji":"👨","label":"Men's",      "priority":"0.9"},
    {"slug":"girls-costumes-and-dresses", "filename":"girls-costumes-and-dresses.html",  "title":f"Girls' Halloween Costumes {YEAR}",        "h1":f"👧 Girls' Halloween Costumes & Dresses {YEAR}",                      "description":f"Adorable girls' Halloween costumes {YEAR}. Princesses, witches, animals, superheroes and more.",                                                           "merchant":"/girls-halloween-costumes.html",      "emoji":"👧","label":"Girls'",     "priority":"0.85"},
    {"slug":"boys-superhero-ninja-costumes","filename":"boys-superhero-ninja-costumes.html","title":f"Boys' Halloween Costumes {YEAR}",       "h1":f"👦 Boys' Halloween Costumes — Superheroes & Ninjas {YEAR}",         "description":f"Top boys' Halloween costumes {YEAR}. Superheroes, ninjas, monsters, pirates and more for every age.",                                                      "merchant":"/boys-halloween-costumes.html",       "emoji":"👦","label":"Boys'",      "priority":"0.85"},
    {"slug":"kids-halloween-outfits",     "filename":"kids-halloween-outfits.html",      "title":f"Kids Halloween Costumes {YEAR}",          "h1":f"👶 Kids Halloween Costumes {YEAR}",                                  "description":f"Huge selection of kids Halloween costumes {YEAR}. All ages, all styles, all budgets. Fast shipping.",                                                      "merchant":"/kids-halloween-costumes.html",       "emoji":"👶","label":"Kids",       "priority":"0.85"},
    {"slug":"cool-teen-costumes",         "filename":"cool-teen-costumes.html",          "title":f"Teen Halloween Costumes {YEAR}",          "h1":f"🧑 Teen Halloween Costumes {YEAR} — Cool & Trendy",                  "description":f"Cool teen Halloween costumes {YEAR}. Trending pop culture, scary, funny, group costumes and more.",                                                        "merchant":"/teen-halloween-costumes.html",       "emoji":"🧑","label":"Teens",      "priority":"0.8"},
    ...
    {"slug":"infant-baby-costumes",       "filename":"infant-baby-costumes.html",        "title":f"Baby Halloween Costumes {YEAR}",          "h1":f"👼 Baby & Infant Halloween Costumes {YEAR}",                         "description":f"Sweet baby Halloween costumes {YEAR}. Soft fabrics, easy snaps, adorable styles for infants 0–24 months.",                                                "merchant":"/baby-halloween-costumes.html",       "emoji":"👼","label":"Babies",     "priority":"0.8"},
    # Extra root-level pages in repo
    {"slug":"adult-costumes-apparel",     "filename":"adult-costumes-apparel.html",      "title":f"Adult Costume Apparel {YEAR}",            "h1":f"🧑 Adult Costume Apparel {YEAR}",                                    "description":f"Shop adult Halloween costume apparel {YEAR}. Huge selection, fast shipping.",                                                                              "merchant":"/adult-halloween-costumes.html",      "emoji":"🧑","label":"Adult",      "priority":"0.75"},
    {"slug":"funny-novelty-costumes",     "filename":"funny-novelty-costumes.html",      "title":f"Funny & Novelty Costumes {YEAR}",         "h1":f"😂 Funny & Novelty Halloween Costumes {YEAR}",                       "description":f"Hilarious funny Halloween costumes {YEAR}. Novelty, gag, and comedy costumes for every event.",                                                            "merchant":"/funny-halloween-costumes.html",      "emoji":"😂","label":"Funny",      "priority":"0.75"},
    {"slug":"scary-horror-costumes",      "filename":"scary-horror-costumes.html",       "title":f"Scary Horror Costumes {YEAR}",            "h1":f"💀 Scary Horror Halloween Costumes {YEAR}",                          "description":f"The scariest horror Halloween costumes {YEAR}. Monsters, killers, demons and more.",                                                                       "merchant":"/scary-halloween-costumes.html",      "emoji":"💀","label":"Scary",      "priority":"0.75"},
    {"slug":"sexy-adult-costumes",        "filename":"sexy-adult-costumes.html",         "title":f"Sexy Adult Halloween Costumes {YEAR}",    "h1":f"🔥 Sexy Adult Halloween Costumes {YEAR}",                            "description":f"Sexy adult Halloween costumes {YEAR}. Flirty, bold and beautiful styles for women and men.",                                                               "merchant":"/sexy-halloween-costumes.html",       "emoji":"🔥","label":"Sexy",       "priority":"0.75"},
    {"slug":"group-family-costumes",      "filename":"group-family-costumes.html",       "title":f"Group & Family Costumes {YEAR}",          "h1":f"👨‍👩‍👧‍👦 Group & Family Halloween Costumes {YEAR}",                             "description":f"Best group and family Halloween costumes {YEAR}. Matching sets for every group size.",                                                                      "merchant":"/group-halloween-costumes.html",      "emoji":"👨‍👩‍👧","label":"Groups",    "priority":"0.75"},
    {"slug":"matching-couples-costumes",  "filename":"matching-couples-costumes.html",   "title":f"Couples Halloween Costumes {YEAR}",       "h1":f"💑 Matching Couples Halloween Costumes {YEAR}",                      "description":f"The best matching couples Halloween costumes {YEAR}. Duo sets for every style.",                                                                           "merchant":"/couples-halloween-costumes.html",    "emoji":"💑","label":"Couples",    "priority":"0.75"},
    {"slug":"mystical-wizard-robes",      "filename":"mystical-wizard-robes.html",       "title":f"Wizard & Mystical Robes {YEAR}",          "h1":f"🧙 Wizard & Mystical Robes {YEAR}",                                  "description":f"Shop wizard robes, mystical costumes and fantasy Halloween outfits {YEAR}.",                                                                               "merchant":"/wizard-costumes.html",               "emoji":"🧙","label":"Wizard",     "priority":"0.7"},
]
...
BEST_PAGES = [
    {"slug":"best-accessories-costumes",    "title":f"Best Halloween Accessories {YEAR}",          "merchant":"/halloween-accessories.html"},
    {"slug":"best-adaptive-costumes",       "title":f"Best Adaptive Halloween Costumes {YEAR}",    "merchant":"/adaptive-costumes.html"},
    {"slug":"best-addamsfamily-costumes",   "title":f"Best Addams Family Costumes {YEAR}",         "merchant":"/addams-family-costumes.html"},
    {"slug":"best-animals-costumes",        "title":f"Best Animal Halloween Costumes {YEAR}",      "merchant":"/animal-costumes.html"},
    {"slug":"best-animatronics-costumes",   "title":f"Best Animatronic Halloween Props {YEAR}",    "merchant":"/animatronic-props.html"},
    {"slug":"best-anime-costumes",          "title":f"Best Anime Halloween Costumes {YEAR}",       "merchant":"/anime-costumes.html"},
    {"slug":"best-beetlejuice-costumes",    "title":f"Best Beetlejuice Costumes {YEAR}",           "merchant":"/beetlejuice-costumes.html"},
    {"slug":"best-bestsellers-costumes",    "title":f"Best Selling Halloween Costumes {YEAR}",     "merchant":"/best-sellers.html"},
    {"slug":"best-budget-costumes",         "title":f"Best Budget Halloween Costumes {YEAR}",      "merchant":"/cheap-halloween-costumes.html"},
    {"slug":"best-candy-costumes",          "title":f"Best Candy Halloween Costumes {YEAR}",       "merchant":"/food-costumes.html"},
    {"slug":"best-carnival-costumes",       "title":f"Best Carnival Costumes {YEAR}",              "merchant":"/carnival-costumes.html"},
    {"slug":"best-casualwear-costumes",     "title":f"Best Halloween Casual Wear {YEAR}",          "merchant":"/halloween-clothing.html"},
    {"slug":"best-celebrations-costumes",   "title":f"Best Celebration Costumes {YEAR}",           "merchant":"/"},
    {"slug":"best-celebrity-costumes",      "title":f"Best Celebrity Halloween Costumes {YEAR}",   "merchant":"/celebrity-costumes.html"},
    {"slug":"best-cheerleader-costumes",    "title":f"Best Cheerleader Costumes {YEAR}",           "merchant":"/cheerleader-costumes.html"},
    {"slug":"best-clearance-costumes",      "title":f"Best Clearance Halloween Costumes {YEAR}",   "merchant":"/clearance-costumes.html"},
    {"slug":"best-clothing-costumes",       "title":f"Best Halloween Clothing {YEAR}",             "merchant":"/halloween-clothing.html"},
    {"slug":"best-collectibles-costumes",   "title":f"Best Halloween Collectibles {YEAR}",         "merchant":"/halloween-collectibles.html"},
    {"slug":"best-comiccon-costumes",       "title":f"Best Comic Con Costumes {YEAR}",             "merchant":"/comic-con-costumes.html"},
    {"slug":"best-convention-costumes",     "title":f"Best Convention Costumes {YEAR}",            "merchant":"/convention-costumes.html"},
    {"slug":"best-cosplayshoes-costumes",   "title":f"Best Cosplay Shoes {YEAR}",                  "merchant":"/cosplay-shoes.html"},
    {"slug":"best-cosplaywigs-costumes",    "title":f"Best Cosplay Wigs {YEAR}",                   "merchant":"/wigs.html"},
    {"slug":"best-couples2-costumes",       "title":f"Best Couples Costumes {YEAR}",               "merchant":"/couples-halloween-costumes.html"},
    {"slug":"best-cowgirl-costumes",        "title":f"Best Cowgirl Costumes {YEAR}",               "merchant":"/cowgirl-costumes.html"},
    {"slug":"best-creepydoll-costumes",     "title":f"Best Creepy Doll Costumes {YEAR}",           "merchant":"/creepy-doll-costumes.html"},
    {"slug":"best-cyberpunk-costumes",      "title":f"Best Cyberpunk Costumes {YEAR}",             "merchant":"/cyberpunk-costumes.html"},
    {"slug":"best-deadbydaylight-costumes", "title":f"Best Dead by Daylight Costumes {YEAR}",      "merchant":"/dead-by-daylight-costumes.html"},
    ...
    {"slug":"best-devilmaycry-costumes",    "title":f"Best Devil May Cry Costumes {YEAR}",         "merchant":"/devil-may-cry-costumes.html"},
    {"slug":"best-digital-costumes",        "title":f"Best Digital Halloween Costumes {YEAR}",     "merchant":"/"},
    {"slug":"best-diy-costumes",            "title":f"Best DIY Halloween Costumes {YEAR}",         "merchant":"/diy-costumes.html"},
    ...
    {"slug":"best-finalfantasy-costumes",   "title":f"Best Final Fantasy Costumes {YEAR}",         "merchant":"/final-fantasy-costumes.html"},
    {"slug":"best-fnaf-costumes",           "title":f"Best FNAF Costumes {YEAR}",                  "merchant":"/fnaf-costumes.html"},
    {"slug":"best-food-costumes",           "title":f"Best Food Halloween Costumes {YEAR}",        "merchant":"/food-costumes.html"},
    {"slug":"best-friendscostume-costumes", "title":f"Best Friends Group Costumes {YEAR}",         "merchant":"/group-halloween-costumes.html"},
    ...
    {"slug":"best-genshin-costumes",        "title":f"Best Genshin Impact Costumes {YEAR}",        "merchant":"/genshin-costumes.html"},
    {"slug":"best-gifts-costumes",          "title":f"Best Halloween Gifts {YEAR}",                "merchant":"/halloween-gifts.html"},
    {"slug":"best-glowinthedark-costumes",  "title":f"Best Glow in the Dark Costumes {YEAR}",     "merchant":"/glow-in-the-dark-costumes.html"},
    {"slug":"best-gnomes-costumes",         "title":f"Best Gnome Costumes {YEAR}",                 "merchant":"/gnome-costumes.html"},
    {"slug":"best-gothic-costumes",         "title":f"Best Gothic Costumes {YEAR}",                "merchant":"/gothic-costumes.html"},
    {"slug":"best-halloweendresses-costumes","title":f"Best Halloween Dresses {YEAR}",             "merchant":"/halloween-dresses.html"},
    {"slug":"best-halloweenfashion-costumes","title":f"Best Halloween Fashion {YEAR}",             "merchant":"/halloween-clothing.html"},
    {"slug":"best-halloweenpajamas-costumes","title":f"Best Halloween Pajamas {YEAR}",             "merchant":"/halloween-pajamas.html"},
    {"slug":"best-halloweensweaters-costumes","title":f"Best Halloween Sweaters {YEAR}",           "merchant":"/halloween-sweaters.html"},
    {"slug":"best-harrypotter-costumes",    "title":f"Best Harry Potter Costumes {YEAR}",          "merchant":"/harry-potter-costumes.html"},
    {"slug":"best-hauntedhouse-costumes",   "title":f"Best Haunted House Costumes {YEAR}",         "merchant":"/scary-halloween-costumes.html"},
    {"slug":"best-hazbinhotel-costumes",    "title":f"Best Hazbin Hotel Costumes {YEAR}",          "merchant":"/hazbin-hotel-costumes.html"},
    {"slug":"best-hocuspocus-costumes",     "title":f"Best Hocus Pocus Costumes {YEAR}",           "merchant":"/hocus-pocus-costumes.html"},
    {"slug":"best-horror-costumes",         "title":f"Best Horror Halloween Costumes {YEAR}",      "merchant":"/scary-halloween-costumes.html"},
    {"slug":"best-horrornight-costumes",    "title":f"Best Horror Night Costumes {YEAR}",          "merchant":"/scary-halloween-costumes.html"},
    {"slug":"best-indoordecor-costumes",    "title":f"Best Indoor Halloween Decorations {YEAR}",   "merchant":"/indoor-halloween-decorations.html"},
    {"slug":"best-inflatable-costumes",     "title":f"Best Inflatable Costumes {YEAR}",            "merchant":"/inflatable-costumes.html"},
    {"slug":"best-jujutsukaisen-costumes",  "title":f"Best Jujutsu Kaisen Costumes {YEAR}",        "merchant":"/jujutsu-kaisen-costumes.html"},
    {"slug":"best-kawaii-costumes",         "title":f"Best Kawaii Costumes {YEAR}",                "merchant":"/kawaii-costumes.html"},
    {"slug":"best-kpop-costumes",           "title":f"Best K-Pop Costumes {YEAR}",                 "merchant":"/kpop-costumes.html"},
    {"slug":"best-larp-costumes",           "title":f"Best LARP Costumes {YEAR}",                  "merchant":"/larp-costumes.html"},
    {"slug":"best-lastminute-costumes",     "title":f"Best Last Minute Halloween Costumes {YEAR}", "merchant":"/last-minute-costumes.html"},
    {"slug":"best-leagueoflegends-costumes","title":f"Best League of Legends Costumes {YEAR}",     "merchant":"/league-of-legends-costumes.html"},
    {"slug":"best-licensed-costumes",       "title":f"Best Licensed Halloween Costumes {YEAR}",    "merchant":"/licensed-costumes.html"},
    {"slug":"best-lighting-costumes",       "title":f"Best Halloween Lighting {YEAR}",             "merchant":"/halloween-lighting.html"},
    {"slug":"best-lolita-costumes",         "title":f"Best Lolita Costumes {YEAR}",                "merchant":"/lolita-costumes.html"},
    {"slug":"best-makeup-costumes",         "title":f"Best Halloween Makeup {YEAR}",               "merchant":"/halloween-makeup.html"},
    {"slug":"best-masks-costumes",          "title":f"Best Halloween Masks {YEAR}",                "merchant":"/halloween-masks.html"},
    {"slug":"best-masquerade-costumes",     "title":f"Best Masquerade Costumes {YEAR}",            "merchant":"/masquerade-costumes.html"},
    {"slug":"best-matchingfamily-costumes", "title":f"Best Matching Family Costumes {YEAR}",       "merchant":"/family-halloween-costumes.html"},
    ...
    {"slug":"best-murdermystery-costumes",  "title":f"Best Murder Mystery Costumes {YEAR}",        "merchant":"/murder-mystery-costumes.html"},
    {"slug":"best-musicartist-costumes",    "title":f"Best Music Artist Costumes {YEAR}",          "merchant":"/music-artist-costumes.html"},
    {"slug":"best-new2026-costumes",        "title":f"Best New Halloween Costumes {YEAR}",         "merchant":"/new-costumes.html"},
    {"slug":"best-nier-costumes",           "title":f"Best Nier Automata Costumes {YEAR}",         "merchant":"/nier-costumes.html"},
    ...
    {"slug":"best-officecostume-costumes",  "title":f"Best Office Halloween Costumes {YEAR}",      "merchant":"/office-costumes.html"},
    {"slug":"best-onepiececosplay-costumes","title":f"Best One Piece Cosplay Costumes {YEAR}",     "merchant":"/one-piece-costumes.html"},
    {"slug":"best-outdoordecor-costumes",   "title":f"Best Outdoor Halloween Decorations {YEAR}",  "merchant":"/outdoor-halloween-decorations.html"},
    {"slug":"best-overwatch-costumes",      "title":f"Best Overwatch Costumes {YEAR}",             "merchant":"/overwatch-costumes.html"},
    {"slug":"best-partysupplies-costumes",  "title":f"Best Halloween Party Supplies {YEAR}",       "merchant":"/halloween-party-supplies.html"},
    {"slug":"best-pet-costumes",            "title":f"Best Pet Halloween Costumes {YEAR}",         "merchant":"/pet-halloween-costumes.html"},
    {"slug":"best-piggyback-costumes",      "title":f"Best Piggyback Costumes {YEAR}",             "merchant":"/piggyback-costumes.html"},
    {"slug":"best-plussize-costumes",       "title":f"Best Plus Size Halloween Costumes {YEAR}",   "merchant":"/plus-size-halloween-costumes.html"},
    {"slug":"best-plussizecosplay-costumes","title":f"Best Plus Size Cosplay Costumes {YEAR}",     "merchant":"/plus-size-cosplay.html"},
    {"slug":"best-preorder-costumes",       "title":f"Best Pre-Order Halloween Costumes {YEAR}",   "merchant":"/pre-order-costumes.html"},
    {"slug":"best-princess-costumes",       "title":f"Best Princess Halloween Costumes {YEAR}",    "merchant":"/princess-costumes.html"},
    {"slug":"best-props-costumes",          "title":f"Best Halloween Props {YEAR}",                "merchant":"/halloween-props.html"},
    {"slug":"best-pumpkin-costumes",        "title":f"Best Pumpkin Costumes {YEAR}",               "merchant":"/pumpkin-costumes.html"},
    {"slug":"best-racer-costumes",          "title":f"Best Racer Costumes {YEAR}",                 "merchant":"/racer-costumes.html"},
    {"slug":"best-renfaire-costumes",       "title":f"Best Renaissance Faire Costumes {YEAR}",     "merchant":"/renaissance-costumes.html"},
    {"slug":"best-sale-costumes",           "title":f"Best Halloween Costume Sales {YEAR}",        "merchant":"/halloween-sale.html"},
    ...
    {"slug":"best-spiderwebs-costumes",     "title":f"Best Spider Web Decorations {YEAR}",         "merchant":"/spider-web-decorations.html"},
    {"slug":"best-steampunk-costumes",      "title":f"Best Steampunk Costumes {YEAR}",             "merchant":"/steampunk-costumes.html"},
    {"slug":"best-sustainable-costumes",    "title":f"Best Sustainable Halloween Costumes {YEAR}", "merchant":"/eco-friendly-costumes.html"},
    {"slug":"best-swimwear-costumes",       "title":f"Best Halloween Swimwear {YEAR}",             "merchant":"/halloween-swimwear.html"},
    {"slug":"best-themes-costumes",         "title":f"Best Themed Halloween Costumes {YEAR}",      "merchant":"/themed-costumes.html"},
    {"slug":"best-tombstones-costumes",     "title":f"Best Halloween Tombstones {YEAR}",           "merchant":"/halloween-tombstones.html"},
    {"slug":"best-trickortreat-costumes",   "title":f"Best Trick or Treat Costumes {YEAR}",        "merchant":"/kids-halloween-costumes.html"},
    {"slug":"best-trunkortreat-costumes",   "title":f"Best Trunk or Treat Costumes {YEAR}",        "merchant":"/trunk-or-treat-costumes.html"},
    {"slug":"best-tvshows-costumes",        "title":f"Best TV Show Halloween Costumes {YEAR}",     "merchant":"/tv-show-costumes.html"},
    {"slug":"best-tween-costumes",          "title":f"Best Tween Halloween Costumes {YEAR}",       "merchant":"/tween-halloween-costumes.html"},
    {"slug":"best-videogame-costumes",      "title":f"Best Video Game Costumes {YEAR}",            "merchant":"/video-game-costumes.html"},
    {"slug":"best-weeklydeals-costumes",    "title":f"Best Halloween Weekly Deals {YEAR}",         "merchant":"/halloween-sale.html"},
    ...
    {"slug":"best-zelda-costumes",          "title":f"Best Zelda Costumes {YEAR}",                 "merchant":"/zelda-costumes.html"},
]
