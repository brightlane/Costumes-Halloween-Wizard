...
PAGES = [
    ...
    {"slug":"girls-costumes-and-dresses", "filename":"girls-costumes-and-dresses.html",  "title":f"Girls' Halloween Costumes {YEAR}",        "h1":f"👧 Girls' Halloween Costumes & Dresses {YEAR}",                      "description":f"Adorable girls' Halloween costumes {YEAR}. Princesses, witches, animals, superheroes and more.",                                                           "merchant":"/girls-costumes.html",      "emoji":"👧","label":"Girls'",     "priority":"0.85"},
    {"slug":"boys-superhero-ninja-costumes","filename":"boys-superhero-ninja-costumes.html","title":f"Boys' Halloween Costumes {YEAR}",       "h1":f"👦 Boys' Halloween Costumes — Superheroes & Ninjas {YEAR}",         "description":f"Top boys' Halloween costumes {YEAR}. Superheroes, ninjas, monsters, pirates and more for every age.",                                                      "merchant":"/boys-costumes.html",       "emoji":"👦","label":"Boys'",      "priority":"0.85"},
